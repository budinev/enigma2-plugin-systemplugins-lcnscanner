...
PluginLanguagePath = '/usr/lib/enigma2/python/Plugins/SystemPlugins/LCNScanner/locale'
...
class LCNScannerPluginSl(Screen, ConfigListScreen, LCNBuildHelper):
	skin = """
		<screen name="LCNScannerPluginSl" position="center,center" size="560,400" title="LCN Scanner">
...
def LCNScannerMain(session, **kwargs):
	session.open(LCNScannerPluginSl)
